...
export class ContactsApi {
    ...
    public async create(
        ...
        options?: RequestOptions): Promise<CreateResponse<Contact>> {
        const {
            workspaceId,
            ...contact
        } = params || {};
    ...
    public async list(
        ...
        options?: RequestOptions): Promise<ApiResponse<ContactCollection>> {
        const {
            workspaceId,
            limit = 20,
            offset = 0,
    ...
    public async retrieve(
        ...
        options?: RequestOptions): Promise<ApiResponse<Contact>> {
        const {
            workspaceId,
            contactId,
            fields,
